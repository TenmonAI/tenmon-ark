 ...
 * - 発生時刻
 * 
 * API: tenmonTrade.getProhibitedPatterns()
 * 
 * 重要:
 * - 編集不可
 * - 削除不可
...
export function KokuzoMemoryPanel() {
  const { data: prohibitedPatterns } = trpc.adminTrade.getKokuzoBlockedPatterns.useQuery(undefined, {
