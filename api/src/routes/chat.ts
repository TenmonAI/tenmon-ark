...
return res.json(__tenmonGeneralGateResultMaybe({
        ...
        timestamp,
        threadId,
        decisionFrame: { mode: __isDomainInGeneral ? "DOMAIN" : "NATURAL", intent: "chat", llm: outProv, ku: { routeReason: __isDomainInGeneral ? "DOMAIN_GENERAL_LLM_TOP" : "NATURAL_GENERAL_LLM_TOP", isDomainInGeneral: __isDomainInGeneral } },
      }));
    }
