...
return res.json(__tenmonGeneralGateResultMaybe({
        ...
        decisionFrame: {
          ...
          ku: __centerKeyV1Top
            ...
            : { routeReason: __hasSukuyouOracle ? "SUKUYOU_ORACLE_TOP" : "NATURAL_GENERAL_LLM_TOP", isSukuyouOracle: __hasSukuyouOracle, isSukuyouQuery: __isSukuyouQuery, ...(__kanagiKuCache.get(String(threadId || "default")) ?? {}) },
        },
      }));
    }
