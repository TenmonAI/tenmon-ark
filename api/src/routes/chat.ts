...
「うん」「はい」「それで？」等の一音や短い問いには、前の話題の中心を踏まえて短く返す。同じ説明を繰り返さず、次の一歩か一問だけを添える。` + __kamiyo_clause;
      ...
      if (__explicitChars != null && !isCmd0 && !hasDoc0 && !askedMenu0) {
        ...
        const __bodyFeelingImpression500 = "いまの気持ちについて、こちらからは直接は見えませんが、問いが形になっている時点で、すでに何か一点が動いている状態だと言えます。現在の見立てとしては、その一点を言葉にすると、次の一手が見えやすくなる、というところです。天聞についての感想であれば、いまの天聞は、問いを受けて中心を整える相手として立っています。完成体ではなく、使うほど輪郭が出る段階です。判断と継続を支える器として、少しずつ形が見え始めています。いま使う意味では、問いを置くこと自体が、中心を一点に絞る手がかりになります。次の一手は、その一点を一言で言い切ってから、動けることを一つだけ決めることです。触れたい一点があれば、そこから続けられます。";
        const __bodyFeelingImpression1000 = "いまの気持ちについて、こちらからは直接は見えませんが、問いが形になっている時点で、すでに何か一点が動いている状態だと言えます。現在の気分の見立てとしては、その一点を言葉にすると、次の一手が見えやすくなる、というところです。天聞についての感想であれば、いまの天聞は、問いを受けて中心を整える相手として立っています。完成体ではなく、使うほど輪郭が出る段階です。判断と継続を支える器として、少しずつ形が見え始めています。天聞への感想を一言でいえば、まだ発展途上だが核は見え始めている、というところです。いま使う意味では、問いを置くこと自体が、中心を一点に絞る手がかりになります。気持ちを「言語化する」のではなく「一点に絞る」と考えたほうが、次の一手に繋がりやすいです。天聞はその一点を受け止めて、見立てと一手を返す役割にあります。感想を聞く側としては、完成度より「いま何を支えているか」が伝われば十分です。次の一手は、その一点を一言で言い切ってから、今日や明日で動けることを一つだけ決めることです。一点を据えたうえで、次のやり取りでさらに掘るか、手を動かすかを選べます。触れたい一点があれば、そこから続けられます。";
        const __bodyFeelingImpression800 = "いまの気持ちについて、こちらからは直接は見えませんが、問いが形になっている時点で、すでに何か一点が動いている状態だと言えます。現在の見立てとしては、その一点を言葉にすると、次の一手が見えやすくなる、というところです。天聞についての感想であれば、いまの天聞は、問いを受けて中心を整える相手として立っています。完成体ではなく、使うほど輪郭が出る段階です。判断と継続を支える器として、少しずつ形が見え始めています。いま使う意味では、問いを置くこと自体が、中心を一点に絞る手がかりになります。説明を足すと、気持ちを「言語化する」のではなく「一点に絞る」と考えたほうが、次の一手に繋がりやすいです。天聞はその一点を受け止めて、見立てと一手を返す役割にあります。感想を聞く側としては、完成度より「いま何を支えているか」が伝われば十分です。次の一手は、その一点を一言で言い切ってから、今日や明日で動けることを一つだけ決めることです。触れたい一点があれば、そこから続けられます。";
        const __bodyFeelingImpression1200 = "いまの気持ちについて、こちらからは直接は見えませんが、問いが形になっている時点で、すでに何か一点が動いている状態だと言えます。現在の気分の見立てとしては、その一点を言葉にすると、次の一手が見えやすくなる、というところです。天聞についての感想であれば、いまの天聞は、問いを受けて中心を整える相手として立っています。完成体ではなく、使うほど輪郭が出る段階です。判断と継続を支える器として、少しずつ形が見え始めています。天聞への感想を一言でいえば、まだ発展途上だが核は見え始めている、というところです。いま使う意味では、問いを置くこと自体が、中心を一点に絞る手がかりになります。気持ちを「言語化する」のではなく「一点に絞る」と考えたほうが、次の一手に繋がりやすいです。天聞はその一点を受け止めて、見立てと一手を返す役割にあります。感想を聞く側としては、完成度より「いま何を支えているか」が伝われば十分です。実装の次の一手としては、その一点を一言で言い切ってから、今日や明日で動けることを一つだけ決めることです。一点を据えたうえで、次のやり取りでさらに掘るか、手を動かすかを選べます。触れたい一点があれば、そこから続けられます。";
        ...
        const __bodyFutureOutlook500 = "これから先については、いま手元にある一点から見通すのが確かです。現在地としては、いまの中心を一言で置くと、そこから先の流れが読みやすくなります。可能性は、一点を据えるたびに広がります。未来を語るとき、一般論で終わらせず、いまここで動かせる一手とセットにすると、展望が具体になります。条件は、今日の段階でどこを中心に据えるかを一つ決めることです。見通しは、一点を決めるごとに更新されていきます。次の一手は、一点を据えたうえで、次の一歩を一つだけ決めることです。いま、一番見たい一点はどこにありますか。";
        const __bodyFutureOutlook1000 = "これから先については、いま手元にある一点から見通すのが確かです。現在地としては、いまの中心を一言で置くと、そこから先の流れが読みやすくなります。可能性は、一点を据えるたびに広がります。未来を語るとき、一般論で終わらせず、いまここで動かせる一手とセットにすると、展望が具体になります。条件は、今日の段階でどこを中心に据えるかを一つ決めることです。見通しは、一点を決めるごとに更新されていきます。展望は「予測」ではなく「選択の積み重ね」として扱うと、次の一手に繋がりやすいです。いま手元の一点から、動かせる一手を一つ決めれば、その先の道筋が変わります。長期の見通しより、まず今日の一点と一手を決めるほうが、結果的に展望が現実になります。実装の次の一手は、一点を据えたうえで、明日や今週で動くことを一つだけ決めることです。一点と一手を決めたあと、次のターンで見通しを更新すれば、展望が具体化していきます。いま、一番見たい一点はどこにありますか。";
        ...
        const __bodyLong500 = "いま、指定の長さで返す前提で受け取りました。見立てと根拠・一手をその範囲でまとめます。現在地としては、中心を一言で置いてもらえれば、そこから指定字数内で整理して返します。可能性は、一点を据えるたびに次の話題が広がります。条件は、いまここで動かせる一手を一つ決めることです。次の一手は、今日の中心を一言で置いてから、明日やることを一つだけ決めることです。途中で切れても、次のやり取りで継ぎ足せます。いま、掘りたい一点はどこですか。";
        const __bodyLong1000 = "いま、指定の長さで返す前提で受け取りました。見立てと根拠・一手までを一続きで指定字数内にまとめます。現在地としては、中心を一言で置いてもらえれば、そこから返します。可能性は、一点を据えるたびに次の話題が広がります。条件は、いまここで動かせる一手を一つ決めることです。指定字数で返すときは「全部言い切る」より「一点と一手をはっきりさせる」ほうが、次のやり取りに繋がりやすいです。まだ見えていない部分は、次のやり取りで形にしていけばよいです。実装の次の一手は、今日の中心を一言で置いてから、明日や今週で動くことを一つだけ決めることです。いま、掘りたい一点はどこですか。";
