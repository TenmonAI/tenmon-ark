...
### 🔥 Phase B：LP-QA（/embed/qa）を"完全にTENMON-ARK人格"に統一 + セッション永続化
...
**完了条件**:
- [ ] futomani88.com 埋め込み版で、TENMON-ARKらしい深さの答えが返る
- [ ] 複数往復してもセッションが切れない
- [ ] TENMON-ARK人格テスト（Persona Unity Test vΩ）の LP側スコアが 0.97 以上
